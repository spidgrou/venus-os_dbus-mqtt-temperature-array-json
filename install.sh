#!/bin/bash
# Installer v12.0 - Direct File Logging (Bypass svlogd)
...
LOG_FILE="$LOG_DIR/current" # Venus OS standard log file name
...
for section in $SECTIONS; do
    ...
    # Create ONLY the main service directory (NO log subdir)
